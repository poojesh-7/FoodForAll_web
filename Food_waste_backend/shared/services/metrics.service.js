...
function getPrometheusMetrics() {
  ...
  const lines = [
    ...
    "# HELP food_rescue_financial_operations_total Financial operation lifecycle outcomes.",
    "# TYPE food_rescue_financial_operations_total counter",
    "# HELP food_rescue_refund_duplicate_operations_total Duplicate refund operations prevented by idempotency.",
    "# TYPE food_rescue_refund_duplicate_operations_total counter",
    "# HELP food_rescue_refund_retry_operations_total Refund operation retry attempts.",
    "# TYPE food_rescue_refund_retry_operations_total counter",
    "# HELP food_rescue_lifecycle_accounting_missing_total Lifecycle terminal states missing deterministic accounting.",
    "# TYPE food_rescue_lifecycle_accounting_missing_total counter",
    "# HELP food_rescue_lifecycle_accounting_completed_total Lifecycle accounting operations completed by source.",
    "# TYPE food_rescue_lifecycle_accounting_completed_total counter",
    "# HELP food_rescue_orphan_financial_state_total Financial terminal states missing required ownership or payment context.",
    "# TYPE food_rescue_orphan_financial_state_total counter",
    "# HELP food_rescue_accounting_invariant_failure_total Lifecycle accounting invariant failures.",
    "# TYPE food_rescue_accounting_invariant_failure_total counter",
