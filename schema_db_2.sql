...
\restrict 7aDl5l7x0XjWHVPyX3dIEsClIWw4c1kGWmW9kxa3jGu2E2pVDFTmFVUgTOL2LZw
...
--
-- Name: guard_payment_financial_state_transition(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.guard_payment_financial_state_transition() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
        DECLARE
...
--
-- Name: log_payment_financial_state_transition(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.log_payment_financial_state_transition() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
        BEGIN
...
--
-- Name: prevent_admin_trust_action_mutation(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.prevent_admin_trust_action_mutation() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
--
-- Name: prevent_cashfree_webhook_audit_mutation(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.prevent_cashfree_webhook_audit_mutation() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
        BEGIN
...
--
-- Name: prevent_compliance_event_mutation(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.prevent_compliance_event_mutation() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
--
-- Name: prevent_financial_ledger_mutation(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.prevent_financial_ledger_mutation() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
--
-- Name: prevent_financial_state_transition_mutation(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.prevent_financial_state_transition_mutation() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
        BEGIN
...
--
-- Name: prevent_incident_management_mutation(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.prevent_incident_management_mutation() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
--
-- Name: prevent_payment_ownership_mutation(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.prevent_payment_ownership_mutation() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
--
-- Name: admin_trust_actions; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.admin_trust_actions (
...
--
-- Name: cashfree_webhook_audit_log; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.cashfree_webhook_audit_log (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    idempotency_key text,
    event_type text,
    order_id text,
...
--
-- Name: cashfree_webhook_events; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: data_archive_records; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.data_archive_records (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
...
--
-- Name: financial_ledger_entries; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: financial_refund_terminal_records; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.financial_refund_terminal_records (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    reservation_id uuid NOT NULL,
    payment_session_id text NOT NULL,
    payment_id uuid,
...
--
-- Name: financial_state_transitions; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.financial_state_transitions (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
...
--
-- Name: moderation_appeal_attachments; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.moderation_appeal_attachments (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
...
--
-- Name: moderation_appeal_events; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: moderation_case_events; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: ngo_requests; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: payment_order_attempts; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.payment_order_attempts (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
...
--
-- Name: payment_ownership; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.payment_ownership (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    reservation_id uuid NOT NULL,
    payment_session_id text NOT NULL,
...
--
-- Name: provider_case_response_attachments; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.provider_case_response_attachments (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
...
--
-- Name: provider_case_responses; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.provider_case_responses (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    case_id uuid NOT NULL,
    provider_id uuid NOT NULL,
...
--
-- Name: provider_report_attachments; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.provider_report_attachments (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
...
--
-- Name: provider_settlements; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: settlement_allocation_snapshots; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.settlement_allocation_snapshots (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    reservation_id uuid NOT NULL,
    payment_id uuid,
    payment_session_id text NOT NULL,
...
--
-- Name: trust_event_effects; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.trust_event_effects (
...
--
-- Name: trust_restrictions; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.trust_restrictions (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
...
--
-- Name: volunteer_stats; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.volunteer_stats (
...
--
-- Name: admin_trust_actions admin_trust_actions_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: admin_trust_actions admin_trust_actions_trust_event_key_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cashfree_webhook_audit_log cashfree_webhook_audit_log_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cashfree_webhook_events cashfree_webhook_events_idempotency_key_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cashfree_webhook_events cashfree_webhook_events_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: data_archive_records data_archive_records_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: financial_ledger_entries financial_ledger_entries_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: financial_refund_terminal_records financial_refund_terminal_records_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: financial_state_transitions financial_state_transitions_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: food_listings food_listings_remaining_quantity_nonnegative; Type: CHECK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: incident_postmortems incident_postmortems_unique_incident; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: moderation_appeal_attachments moderation_appeal_attachments_archive_status_valid; Type: CHECK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: moderation_appeal_attachments moderation_appeal_attachments_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: moderation_appeal_events moderation_appeal_events_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: moderation_case_events moderation_case_events_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: ngo_requests ngo_requests_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: ngos ngos_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: notifications notifications_archive_status_valid; Type: CHECK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: payment_order_attempts payment_order_attempts_order_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: payment_order_attempts payment_order_attempts_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: payment_ownership payment_ownership_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: provider_case_response_attachments provider_case_response_attachments_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: provider_case_responses provider_case_responses_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: provider_report_attachments provider_report_attachments_archive_status_valid; Type: CHECK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: provider_report_attachments provider_report_attachments_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: provider_settlements provider_settlements_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: retention_policies retention_policies_policy_key_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: settlement_allocation_snapshots settlement_allocation_snapshots_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: settlement_batches settlement_batches_batch_reference_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: trust_event_effects trust_event_effects_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: trust_events trust_events_event_key_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: trust_restrictions trust_restrictions_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: trust_scores trust_scores_cancellation_count_nonnegative; Type: CHECK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: trust_scores trust_scores_completion_count_nonnegative; Type: CHECK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: trust_scores trust_scores_failure_count_nonnegative; Type: CHECK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: trust_scores trust_scores_fulfillment_count_nonnegative; Type: CHECK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: trust_scores trust_scores_projected_deposit_multiplier_minimum; Type: CHECK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: trust_scores trust_scores_projected_restriction_level_bounds; Type: CHECK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: trust_scores trust_scores_recovery_progress_bounds; Type: CHECK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: trust_scores trust_scores_refund_count_nonnegative; Type: CHECK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: trust_scores trust_scores_risk_category_check; Type: CHECK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: trust_scores trust_scores_streaks_nonnegative; Type: CHECK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: trust_scores trust_scores_timeout_count_nonnegative; Type: CHECK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: restaurants unique_fssai; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: ratings unique_listing_reviewer; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: notifications unique_notification_per_listing; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: users unique_phone; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: restaurants unique_provider_restaurant; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: ratings unique_rating_per_reservation; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: ngos unique_registration; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: ngos unique_user_ngo; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: restaurants unique_user_restaurant; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: volunteers unique_volunteer_ngo; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: volunteer_stats volunteer_stats_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: idx_admin_trust_actions_admin_created; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_admin_trust_actions_created; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_admin_trust_actions_idempotency; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_admin_trust_actions_subject_created; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_admin_trust_actions_type_created; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_business_metrics_food_listings_created; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_business_metrics_food_listings_provider_created; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_business_metrics_moderation_appeals_submitted; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_business_metrics_provider_reports_created; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_business_metrics_provider_reports_status_resolved; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_business_metrics_provider_settlements_created; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_business_metrics_provider_settlements_status_updated; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_business_metrics_refund_terminal_created; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_business_metrics_reservations_completed; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_business_metrics_reservations_picked_up; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_business_metrics_reservations_reserved; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_business_metrics_reservations_volunteer; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_cashfree_webhook_audit_order; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_cashfree_webhook_audit_refund; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_cashfree_webhook_audit_status; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_cashfree_webhook_events_order; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_cashfree_webhook_events_order_recent; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_cashfree_webhook_events_status; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_compliance_events_created; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_compliance_events_request; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_compliance_events_target; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_data_archive_records_policy_status; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_data_archive_records_source; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_data_deletion_requests_status_requested; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_data_deletion_requests_subject; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_data_deletion_requests_target_user; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_financial_ledger_entries_event_type; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_financial_ledger_entries_idempotency_key; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_financial_ledger_entries_payment_session; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_financial_ledger_entries_refund; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_financial_ledger_entries_reservation; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_financial_operations_idempotency_key; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_financial_operations_operation_source; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_financial_operations_payment_ownership; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_financial_operations_payment_session; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_financial_operations_reservation; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_financial_operations_status; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_financial_refund_terminal_idempotency_key; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_financial_refund_terminal_once; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_financial_refund_terminal_refund; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_financial_state_transitions_payment; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_financial_state_transitions_reservation; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_food_listings_active_scan; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_food_listings_location_gist; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_food_listings_provider_status; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_food_listings_visibility; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_food_location; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_food_ngo; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_food_remaining; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_food_status; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_incident_events_actor_created; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_incident_events_assignment; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_incident_events_incident_created; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_incident_events_status; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_incident_events_timeline; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_incident_notes_incident_created; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_incident_postmortems_incident; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_incident_records_created; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_incident_records_created_by; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_incident_records_severity_category; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_incident_records_source_ref; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_moderation_appeal_attachments_appeal; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_moderation_appeal_attachments_archive; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_moderation_appeal_attachments_uploader_created; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_moderation_appeal_events_actor_created; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_moderation_appeal_events_appeal_created; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_moderation_appeal_events_case_created; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_moderation_appeals_case_provider; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_moderation_appeals_case_status_created; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_moderation_appeals_provider_status_created; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_moderation_appeals_provider_updated; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_moderation_appeals_status_submitted; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_moderation_appeals_status_updated; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_moderation_case_events_actor_created; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_moderation_case_events_case_created; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_moderation_case_events_type_status_created; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_moderation_cases_source_report; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_moderation_cases_status_created; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_moderation_cases_status_updated; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_moderation_cases_subject_created; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_moderation_cases_subject_status; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_ngo_requests_pending_listing; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_ngos_location; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_ngos_user_verified_lookup; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_ngos_verification; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_notifications_archive_status_created; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_notifications_idempotency_key; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_notifications_user_active_archive; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_operational_alerts_open_key; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_operational_events_category; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_operational_events_correlation; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_operational_events_created; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_payment_order_attempts_payer; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_payment_order_attempts_status_updated; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_payment_ownership_payer; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_payment_ownership_payment_session; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_payment_ownership_provider; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_payment_ownership_refund_target; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_payment_ownership_reservation; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_payment_ownership_reservation_session_version; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_payments_deposit_refund_id_unique; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_payments_order_reservation_lock; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_payments_order_status; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_payments_reconciliation; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_payments_refund_id_unique; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_payments_refund_pending; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_payments_reservation_status_updated; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_payments_transaction_id_unique; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_provider_case_response_attachments_response; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_provider_case_responses_case_provider; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_provider_case_responses_provider_updated; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_provider_report_attachments_archive; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_provider_report_attachments_report; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_provider_report_attachments_uploader_created; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_provider_reports_reporter_provider_created; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_provider_reports_reporter_status_created; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_provider_reports_unique_pending; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_provider_settlements_batch; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_provider_settlements_idempotency_key; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_provider_settlements_provider_status; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_ratings_listing_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_ratings_reservation_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_ratings_reviewer_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_reservations_listing_payment_state; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_reservations_listing_reserved; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_reservations_listing_status; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_reservations_payment_reconcile_order; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_reservations_pending_payment; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_reservations_user_abandoned_hold_patterns; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_reservations_user_active_unpaid_holds; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_reservations_user_lifecycle; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_reservations_user_status; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_reservations_volunteer_tasks; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_restaurants_user_verified_lookup; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_restaurants_verification; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_settlement_allocation_idempotency_key; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_settlement_allocation_provider; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_settlement_allocation_reservation_session_version; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_trust_event_effects_subject; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_trust_events_payment; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_trust_events_processing; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_trust_events_provider_pairings; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_trust_events_reservation; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_trust_events_subject_daily_gain; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_trust_events_subject_history; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_trust_events_type_created; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_trust_restrictions_subject; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_trust_restrictions_subject_type; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_trust_scores_operational_risk; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_trust_scores_projected_cooldown; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_volunteer_requests_lookup; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_volunteers_ngo; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_volunteers_user; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: unique_active_reservation; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: unique_pending_payment_reservation; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: unique_volunteer_active_task; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: admin_trust_actions trg_admin_trust_actions_immutable; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_admin_trust_actions_immutable BEFORE DELETE OR UPDATE ON public.admin_trust_actions FOR EACH ROW EXECUTE FUNCTION public.prevent_admin_trust_action_mutation();


--
-- Name: cashfree_webhook_audit_log trg_cashfree_webhook_audit_immutable; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_cashfree_webhook_audit_immutable BEFORE DELETE OR UPDATE ON public.cashfree_webhook_audit_log FOR EACH ROW EXECUTE FUNCTION public.prevent_cashfree_webhook_audit_mutation();


--
-- Name: compliance_events trg_compliance_events_immutable; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_compliance_events_immutable BEFORE DELETE OR UPDATE ON public.compliance_events FOR EACH ROW EXECUTE FUNCTION public.prevent_compliance_event_mutation();


--
-- Name: financial_ledger_entries trg_financial_ledger_entries_immutable; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_financial_ledger_entries_immutable BEFORE DELETE OR UPDATE ON public.financial_ledger_entries FOR EACH ROW EXECUTE FUNCTION public.prevent_financial_ledger_mutation();


--
-- Name: financial_refund_terminal_records trg_financial_refund_terminal_immutable; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_financial_refund_terminal_immutable BEFORE DELETE OR UPDATE ON public.financial_refund_terminal_records FOR EACH ROW EXECUTE FUNCTION public.prevent_financial_ledger_mutation();


--
-- Name: financial_state_transitions trg_financial_state_transitions_immutable; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_financial_state_transitions_immutable BEFORE DELETE OR UPDATE ON public.financial_state_transitions FOR EACH ROW EXECUTE FUNCTION public.prevent_financial_state_transition_mutation();


--
-- Name: incident_events trg_incident_events_immutable; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_incident_events_immutable BEFORE DELETE OR UPDATE ON public.incident_events FOR EACH ROW EXECUTE FUNCTION public.prevent_incident_management_mutation();


--
-- Name: incident_notes trg_incident_notes_immutable; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_incident_notes_immutable BEFORE DELETE OR UPDATE ON public.incident_notes FOR EACH ROW EXECUTE FUNCTION public.prevent_incident_management_mutation();


--
-- Name: incident_postmortems trg_incident_postmortems_immutable; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_incident_postmortems_immutable BEFORE DELETE OR UPDATE ON public.incident_postmortems FOR EACH ROW EXECUTE FUNCTION public.prevent_incident_management_mutation();


--
-- Name: incident_records trg_incident_records_immutable; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_incident_records_immutable BEFORE DELETE OR UPDATE ON public.incident_records FOR EACH ROW EXECUTE FUNCTION public.prevent_incident_management_mutation();


--
-- Name: payment_ownership trg_payment_ownership_immutable; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_payment_ownership_immutable BEFORE DELETE OR UPDATE ON public.payment_ownership FOR EACH ROW EXECUTE FUNCTION public.prevent_payment_ownership_mutation();


--
-- Name: payments trg_payments_financial_state_guard; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: payments trg_payments_financial_state_transition_log; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: settlement_allocation_snapshots trg_settlement_allocation_immutable; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_settlement_allocation_immutable BEFORE DELETE OR UPDATE ON public.settlement_allocation_snapshots FOR EACH ROW EXECUTE FUNCTION public.prevent_financial_ledger_mutation();


--
-- Name: admin_trust_actions admin_trust_actions_admin_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: compliance_events compliance_events_actor_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: compliance_events compliance_events_deletion_request_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: compliance_events compliance_events_policy_key_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: data_archive_records data_archive_records_archived_by_admin_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: data_archive_records data_archive_records_policy_key_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: data_deletion_requests data_deletion_requests_approved_by_admin_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: data_deletion_requests data_deletion_requests_executed_by_admin_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: data_deletion_requests data_deletion_requests_policy_key_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: data_deletion_requests data_deletion_requests_requested_by_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: data_deletion_requests data_deletion_requests_reviewed_by_admin_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: data_deletion_requests data_deletion_requests_target_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: financial_ledger_entries financial_ledger_entries_actor_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: financial_ledger_entries financial_ledger_entries_counterparty_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: financial_ledger_entries financial_ledger_entries_payment_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: financial_ledger_entries financial_ledger_entries_payment_ownership_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: financial_ledger_entries financial_ledger_entries_provider_settlement_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: financial_ledger_entries financial_ledger_entries_reservation_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: financial_ledger_entries financial_ledger_entries_settlement_allocation_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: financial_ledger_entries financial_ledger_entries_settlement_batch_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: financial_operations financial_operations_actor_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: financial_operations financial_operations_payment_ownership_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: financial_operations financial_operations_reservation_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: financial_refund_terminal_records financial_refund_terminal_records_payment_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: financial_refund_terminal_records financial_refund_terminal_records_reservation_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: financial_state_transitions financial_state_transitions_payment_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: financial_state_transitions financial_state_transitions_reservation_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: ratings fk_ratings_listing; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: ratings fk_ratings_reservation; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: ratings fk_ratings_reviewer; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: food_listings food_listings_ngo_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: food_listings food_listings_provider_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: incident_events incident_events_actor_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: incident_events incident_events_from_assigned_admin_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: incident_events incident_events_note_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: incident_events incident_events_postmortem_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: incident_events incident_events_to_assigned_admin_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: incident_notes incident_notes_admin_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: incident_postmortems incident_postmortems_admin_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: incident_postmortems incident_postmortems_incident_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: incident_records incident_records_created_by_admin_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: moderation_appeal_attachments moderation_appeal_attachments_appeal_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: moderation_appeal_attachments moderation_appeal_attachments_archived_by_admin_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: moderation_appeal_attachments moderation_appeal_attachments_retention_policy_key_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: moderation_appeal_attachments moderation_appeal_attachments_uploader_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: moderation_appeal_events moderation_appeal_events_actor_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: moderation_appeal_events moderation_appeal_events_appeal_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: moderation_appeal_events moderation_appeal_events_case_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: moderation_appeals moderation_appeals_provider_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: moderation_appeals moderation_appeals_reviewed_by_admin_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: moderation_appeals moderation_appeals_withdrawn_by_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: moderation_case_events moderation_case_events_actor_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: moderation_case_events moderation_case_events_case_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: moderation_cases moderation_cases_assigned_admin_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: moderation_cases moderation_cases_opened_by_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: moderation_cases moderation_cases_source_report_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: moderation_cases moderation_cases_subject_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: ngo_requests ngo_requests_listing_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: ngo_requests ngo_requests_ngo_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: ngos ngos_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: notifications notifications_archived_by_admin_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: notifications notifications_retention_policy_key_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: payment_order_attempts payment_order_attempts_payer_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: payment_ownership payment_ownership_beneficiary_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: payment_ownership payment_ownership_commission_receiver_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: payment_ownership payment_ownership_deposit_owner_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: payment_ownership payment_ownership_payer_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: payment_ownership payment_ownership_provider_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: payment_ownership payment_ownership_refund_target_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: payment_ownership payment_ownership_reservation_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: penalties penalties_ngo_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: penalties penalties_reservation_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: penalties penalties_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: provider_case_response_attachments provider_case_response_attachments_response_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: provider_case_responses provider_case_responses_case_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: provider_case_responses provider_case_responses_provider_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: provider_report_attachments provider_report_attachments_archived_by_admin_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: provider_report_attachments provider_report_attachments_report_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: provider_report_attachments provider_report_attachments_retention_policy_key_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: provider_report_attachments provider_report_attachments_uploader_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: provider_reports provider_reports_moderation_case_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: provider_reports provider_reports_provider_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: provider_reports provider_reports_reported_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: provider_reports provider_reports_reservation_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: provider_reports provider_reports_reviewed_by_admin_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: provider_settlements provider_settlements_payment_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: provider_settlements provider_settlements_provider_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: provider_settlements provider_settlements_reservation_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: provider_settlements provider_settlements_settlement_allocation_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: provider_settlements provider_settlements_settlement_batch_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: reservations reservations_assigned_volunteer_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: settlement_allocation_snapshots settlement_allocation_snapshots_payment_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: settlement_allocation_snapshots settlement_allocation_snapshots_payment_ownership_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: settlement_allocation_snapshots settlement_allocation_snapshots_reservation_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: trust_event_effects trust_event_effects_event_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: volunteer_requests volunteer_requests_ngo_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: volunteer_requests volunteer_requests_volunteer_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: volunteer_stats volunteer_stats_volunteer_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: volunteers volunteers_ngo_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
